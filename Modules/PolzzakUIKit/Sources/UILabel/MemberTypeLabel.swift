...
public final class MemberTypeLabel: PaddedLabel {
    public enum Constants {
        public static let padding = UIEdgeInsets(top: 4, left: 10, bottom: 4, right: 10)
    }
    
    public override init(padding: UIEdgeInsets = Constants.padding) {
