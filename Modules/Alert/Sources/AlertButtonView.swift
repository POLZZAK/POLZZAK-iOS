...
open class AlertButtonView: BaseAlertViewController {
    ...
    public var firstButtonAction: ButtonAction?
    @MainActor public var secondButtonAction: ButtonAction?
    ...
    public let closeButton: PaddedLabel = {
    ...
    public let confirmButton: PaddedLabel = {
    ...
    public init(buttonStyle: ButtonStyle, contentStyle: ContentStyle) {
