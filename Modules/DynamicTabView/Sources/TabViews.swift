...
public protocol TabViewsDelegate: AnyObject {
    func tabViews(_ tabViews: TabViews, didSelectTabAtIndex index: Int)
}

public final class TabViews: UIStackView {
    public weak var delegate: TabViewsDelegate?
    ...
    public init(frame: CGRect = .zero, tabViews: [TabView] = []) {
...
extension TabViews {
    ...
    public func setTouchInteractionEnabled(_ enabled: Bool) {
        isUserInteractionEnabled = enabled
    }
    
    public func updateNewAlert(index: Int, state: Bool) {
